...
- `npm run check`: strict TypeScript checking, esbuild bundling, and all 19 automated tests pass.
...
- Manifest and package versions are `0.1.2`; the compatibility map records Obsidian `1.13.7`.
...
List tests cover ordered/unordered/task boundaries, nested and loose lists, single-item lists, body/list adjacency, reading-view candidate selection, settings migration, and editing lists into paragraphs.
...
- List boundaries, long items that wrap, nested and loose lists, task checkboxes, and lists ending in rendered widgets.
